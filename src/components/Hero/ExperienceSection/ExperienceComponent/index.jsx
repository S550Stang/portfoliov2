...
export default function ExperienceComponent() {
  return (
    <div>
      ...
      <div className="relative left-0 right-0 -top-20 sm:-top-44 md:-top-60 lg:-top-60 xl:-top-60 2xl:-top-[700px] lg:flex lg:justify-between lg:px-20 lg:space-x-5 2xl:px-28 ">
