  ...
  return (
    <div className="mt-10 2xl:mt-0">
      ...
      <motion.div className="relative">
        ...
        <div className="relative left-0 right-0 -top-28 sm:-top-44 md:-top-60 lg:-top-60 xl:-top-60 2xl:-top-[600px] lg:flex lg:justify-between lg:px-20 lg:space-x-5 2xl:px-28 w-screen  ">
          <div className="lg:grid lg:grid-cols-2 mt-10 gap-10 xl:gap-40 2xl:space-x-54 mx-auto px-2  ">
            ...
            <div className="flex justify-center items-center font-Lato mb-10 2xl:w-96 ">
              <div className=" w-52 h-44  sm:w-56 sm:h-56 md:w-64 xl:w-80 2xl:w-full 2xl:h-full rounded-3xl flex flex-col justify-center items-center  bg-gradient-to-l from-[#3F37C9]  to-transparent bg-opacity-40  backdrop-blur-md border border-white    gap-3 sm:gap-5">
            ...
            <div className="flex justify-center items-center font-Lato mb-10">
              <div className=" w-52 h-44  sm:w-56 sm:h-56 md:w-64 xl:w-80 2xl:w-96 rounded-3xl flex flex-col justify-center items-center bg-gradient-to-r from-[#3F37C9]  to-transparent bg-opacity-40  backdrop-blur-md border border-white     gap-3 sm:gap-5">
            ...
            <div className="flex justify-center items-center font-Lato mb-10 lg:grid lg:col-span-2 ">
              <div className=" w-52 h-44 sm:w-56 sm:h-56 md:w-64 lg:w-96 rounded-3xl flex flex-col justify-center items-center  bg-gradient-to-br from-[#3F37C9]  to-transparent bg-opacity-40  backdrop-blur-md border border-white    gap-3 sm:gap-5 ">
